 ...
 *
 * This template can be overridden by copying it to yourtheme/learnpress/addons/h5p/content-h5p/summary/markthewords.php.
 *
 * @author  ThimPress
...
if ( isset( $params->textField ) && $params->textField != '' ) {
	echo preg_replace('#\*([^\*]*)\*#', '<span class="mark_word_here">$1</span>', $params->textField);
}
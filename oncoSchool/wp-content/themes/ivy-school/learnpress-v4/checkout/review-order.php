...
<div id="checkout-order" class="lp-checkout-block right">
	...
	<h4><?php esc_html_e( 'Your order', 'course-builder' ); ?></h4>

	<div class="lp-checkout-order__inner">
		<table class= "learn-press-checkout-review-order-table" >
		<thead>
			<tr>
				<th class="course-name" colspan="2" ><?php _e( 'Course', 'course-builder' ); ?></th>
				<th class="course-total"><?php _e( 'Total', 'course-builder' ); ?></th>
			</tr>
		</thead>
			<tbody>
			...
			<tr class="cart-subtotal">
				...
				<th colspan="2"><?php _e( 'Subtotal', 'course-builder' ); ?></th>
			...
			<tr class="order-total">
				...
				<th colspan="2"><?php esc_html_e( 'Total', 'course-builder' ); ?></th>

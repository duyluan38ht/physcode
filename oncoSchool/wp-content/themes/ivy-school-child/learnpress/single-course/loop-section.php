...
if (!is_user_logged_in()) { ?>
	...
	<div class="section active-accordion" id="section-<?php echo esc_attr($section->get_id()); ?>" data-id="<?php echo esc_attr($section->get_id()); ?>">
...
<?php } else { ?>
	...
	<div class="section js-call-accordion <?php if ($cls_active) echo 'active-accordion'; ?>" id="section-<?php echo esc_attr($section->get_id()); ?>" data-id="<?php echo esc_attr($section->get_id()); ?>">

...
$style = isset( $params['style_layout'] ) ? 'style-' . $params['style_layout'] : '';

?>

<!--counter box element-->
<div
	class="bp-element bp-element-counter-box <?php echo esc_attr( $style ); ?> text-<?php echo esc_attr( $align ); ?> <?php echo esc_attr( $el_class ); ?> <?php echo esc_attr( $layout ); ?> <?php echo is_plugin_active( 'js_composer/js_composer.php' ) ? vc_shortcode_custom_css_class( $bp_css ) : ''; ?>" <?php echo $el_id ? " id='" . esc_attr( $el_id ) . "'" : '' ?> <?php echo $data_tablet; ?> <?php echo $data_mobile; ?>>

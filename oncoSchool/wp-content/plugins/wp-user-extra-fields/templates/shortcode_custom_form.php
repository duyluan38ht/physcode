...
<div id="wpuef-extra-fields-custom-form-<?php echo $random;?>" class="wpuef-extra-fields-custom-form">
	...
	?>
			...
			<?php 
				...
				?>
				<select class="wpuef_input_select" id="<?php echo "wpuef_field_".$extra_field->cid; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($read_only) echo ' disabled="disabled"'; if($required) echo 'required="required"';?>>
			...
			<?php elseif($extra_field->field_type == "checkboxes"): ?>
				...
				$default = 	!isset($field_value) ? $extra_option->checked : false; ?>
				<input type="hidden" value="<?php if(isset($field_value[$index]) || $default ) echo 'true'; else 'null';?>" id="<?php echo $extra_field->cid."-".$index; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>][<?php echo $index ?>]" />
					<input type="checkbox" <?php if(isset($field_value[$index]) || $default ) echo 'checked';?>  id="<?php echo "wpuef_field_".$extra_field->cid; ?>" value="<?php echo $index ?>" data-id="<?php echo $extra_field->cid."-".$index;?>" <?php if($required) echo 'required="required" class="wpuef_checkbox wpuef_checkbox_perform_check wpuef_checkobox_group_'.$extra_field->cid.'" '; else echo 'class = "wpuef_checkbox"'; ?> <?php if($read_only) echo 'readonly="readonly" ';?> <?php if($read_only) echo 'readonly="readonly" ';?>><span class="wpuef_checkbox_label"><?php echo $extra_option->label; ?></span></input><br/>
				<?php endforeach; ?>
			...
			<?php elseif($extra_field->field_type == "website"): ?>
				<input class="wpuef_input_url" type="url" value="<?php echo $field_value; ?>" id="<?php echo "wpuef_field_".$extra_field->cid; ?>" placeholder="<?php echo $placeholder; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($required) echo 'required="required"';?>  <?php if($read_only) echo 'readonly="readonly" ';?>></input>
			...
			<?php elseif($extra_field->field_type != "title_no_input"): ?>
				<input class="wpuef_input_text" type="<?php echo $extra_field->field_type; ?>" id="<?php echo "wpuef_field_".$extra_field->cid; ?>" placeholder="<?php echo $placeholder; ?>" value="<?php echo $field_value; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($required) echo 'required="required"';?> <?php if($read_only) echo 'readonly="readonly" ';?>/>
			<?php endif; 
			//End types
			?>

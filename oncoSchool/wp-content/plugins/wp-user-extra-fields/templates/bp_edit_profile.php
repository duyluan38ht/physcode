...
?>
	...
	<?php elseif($extra_field->field_type == "radio"): ?>
		<?php foreach($extra_field->field_options->options as $index => $extra_option):
			$field_value = !isset($field_value) && $extra_option->checked?  $index : $field_value; 		?>
			<input type="radio" id="<?php echo "wpuef_field_".$extra_field->cid; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" value="<?php echo $index; ?>" <?php if($field_value == $index) echo 'checked';?> <?php if($required) echo 'required="required"';?> <?php if($read_only) echo ' disabled="disabled" readonly="readonly" ';?>><span class="wpuef_checkbox_label"><?php echo $extra_option->label; ?></span></input><br/>
		<?php endforeach; ?>
	...
	<?php elseif($extra_field->field_type == "date"): 
		...
		?>
		 <input class="<?php if(!$read_only) echo 'wpuef_input_date'?>" id="<?php echo "wpuef_field_".$extra_field->cid; ?>" type="text" placeholder="<?php echo $placeholder; ?>" value="<?php echo $field_value; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($required) echo 'required="required"';?> <?php if($read_only) echo ' disabled="disabled" ';?>></input>
	<?php elseif($extra_field->field_type == "time"): ?>
		 <input class="<?php if(!$read_only) echo 'wpuef_input_time'?> " id="<?php echo "wpuef_field_".$extra_field->cid; ?>" type="text" placeholder="<?php echo $placeholder; ?>" value="<?php echo $field_value; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($required) echo 'required="required"';?> <?php if($read_only) echo ' disabled="disabled" ';?>></input>
	
	<?php elseif($extra_field->field_type == "website"): ?>
		<input class="wpuef_input_url" type="url" value="<?php echo $field_value; ?>" id="<?php echo "wpuef_field_".$extra_field->cid; ?>" placeholder="<?php echo $placeholder; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($required) echo 'required="required"';?>  <?php if($read_only) echo ' disabled="disabled" ';?>></input>

	<?php elseif($extra_field->field_type == "paragraph" || ($extra_field->field_type == "html" && !$read_only)): ?>
		<textarea  class="wpuef_input_textarea" name="wpuef_options[<?php echo $extra_field->cid; ?>]" id="<?php echo "wpuef_field_".$extra_field->cid; ?>" placeholder="<?php echo $placeholder; ?>" <?php if($required) echo 'required="required"';?>  <?php if($read_only) echo ' disabled="disabled" ';?>><?php echo $field_value; ?></textarea>
	...
	<?php elseif($extra_field->field_type != "title_no_input"): ?>
		<input class="wpuef_input_text" type="<?php echo $extra_field->field_type; ?>" id="<?php echo "wpuef_field_".$extra_field->cid; ?>" placeholder="<?php echo $placeholder; ?>" value="<?php echo $field_value; ?>" name="wpuef_options[<?php echo $extra_field->cid; ?>]" <?php if($required) echo 'required="required"';?> <?php if($read_only) echo ' disabled="disabled"';?>/>
	<?php endif; 
	//End types
	?>
